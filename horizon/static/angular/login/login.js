...
(function () {
    ...
    angular.module('hz').controller('hzLoginCtrl', function ($scope, $http, $cookies) {
        ...
        $scope.logout = function(){
            $http.get('http://localhost:9000/auth/logout/').then(function(resp){
                console.log(resp);
            });
    ...
    function modals($rootScope, $q) {
        ...
        var params, proceedTo, resolve, reject;
        return ({
            open: open,
            params: params,
            proceedTo: proceedTo,
